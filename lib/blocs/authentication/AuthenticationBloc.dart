...
class AuthenticationBloc
  ...
  AuthenticationBloc([this.authenticationRepository, this.userDataRepository, this.storageRepository])
      : assert(authenticationRepository != null),
        assert(userDataRepository != null),
        assert(storageRepository != null),
        super(Uninitialized());
  ...
  Stream<AuthenticationState> mapSaveProfileToState(
    ...
    firebase.User user = await authenticationRepository.getCurrentUser(); // retrieve user from firebase
