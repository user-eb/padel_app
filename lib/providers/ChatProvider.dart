...
class ChatProvider extends BaseChatProvider {
  ...
  ChatProvider({FirebaseFirestore fireStoreDb})
      : fireStoreDb = fireStoreDb ?? FirebaseFirestore.instance.enablePersistence();
  ...
  Future<String> createChatIdForUsers(String selfUsername,
    ...
    String selfUid  =(await  userUidMapCollection.doc(selfUsername).get()).data()['uid'];
    String contactUid  = (await userUidMapCollection.doc(contactUsername).get()).data()['uid'];
